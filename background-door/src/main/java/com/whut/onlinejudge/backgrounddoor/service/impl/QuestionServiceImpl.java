...
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question>
    ...
    public Long addQuestion(QuestionAddRequest questionAddRequest) {
        ...
        final List<JudgeCaseWithStringFiled> judgeCase = questionAddRequest.getJudgeCase();
    ...
    public Boolean updateQuestion(QuestionUpdateRequest questionUpdateRequest) {
        ...
        final List<JudgeCaseWithStringFiled> judgeCase = questionUpdateRequest.getJudgeCase();
